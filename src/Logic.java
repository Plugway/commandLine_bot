...
public class Logic {
    ...
    private static Scanner in = new Scanner(System.in); //убрать
    ...
    private static void runProgram() throws IOException {
        ...
        var givenQuestNum = 0;
        var maxQuestNum = getQuestionNumber(totalQuestionsAvailable);
        var score = 0;
        ...
        while (!quitQuestFlag)
        {
            ...
            //try
            var intInput = getIntInputArray(input);
            //catch неправильный ввод
    ...
    private static int getQuestionNumber(int totalQuestionsAvailable)
    {
        ...
        while (!inputIsNumber & !inputIsGood) {
            try {
                ...
                if (maxQuestNum <= totalQuestionsAvailable)
                {
                    inputIsGood = true;
                    inputIsNumber = true;
                }
